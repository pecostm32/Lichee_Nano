...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/lichee_nano_ch340_sd_package.elf

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/lichee_nano_ch340_sd_package.elf: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	arm-none-eabi-gcc -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/lichee_nano_ch340_sd_package.elf ${OBJECTFILES} ${LDLIBSOPTIONS} -T./lichee_nano_sd_bl.ld -nostdlib -lgcc
...
${OBJECTDIR}/lichee_nano_ch340_sd_package.o: lichee_nano_ch340_sd_package.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lichee_nano_ch340_sd_package.o lichee_nano_ch340_sd_package.c
