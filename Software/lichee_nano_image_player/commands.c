...
uint64 fpgaaddress;
uint64 fpgawritebyte;
uint64 fpgawriteshort;
uint64 fpgawriteint;
uint64 fpgawritelong;
...
{
  { "WC",                      2,  0,              255, &fpgaaddress,             NULL, writefpgacontrol },
  ...
  { "WL",                      2,  0,  281474976710655, &fpgawritelong,           NULL,    writefpgalong },
...
void writefpgacontrol(void)
{
  fpga_strobe_control(fpgaaddress);
}
