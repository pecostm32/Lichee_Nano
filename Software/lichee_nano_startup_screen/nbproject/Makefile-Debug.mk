...
OBJECTFILES= \
	...
	${OBJECTDIR}/lichee_nano_startup_screen.o \
	${OBJECTDIR}/memcmp.o \
	${OBJECTDIR}/memcpy.o \
	${OBJECTDIR}/memset.o \
...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/lichee_nano_startup_screen.elf

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/lichee_nano_startup_screen.elf: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	arm-none-eabi-gcc -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/lichee_nano_startup_screen.elf ${OBJECTFILES} ${LDLIBSOPTIONS} -T./fnirsi_1013d.ld -nostdlib -lgcc
...
${OBJECTDIR}/lichee_nano_startup_screen.o: lichee_nano_startup_screen.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lichee_nano_startup_screen.o lichee_nano_startup_screen.c
